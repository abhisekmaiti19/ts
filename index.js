...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementsByClassName("custmonDropDwon")
    .addEventListener("custmonDropDwon", function (e) {
  ...
  document
    ...
    .addEventListener("click", function () {
      document
        .getElementsByClassName("filterToggel")
    ...
    function (e) {
      ...
      if (
        ...
        if (target.hasAttribute("data-target")) {
          ...
          if (m_ID == "LoginBox") {
            document.getElementsByID("login_error").style = "display: none";
            document.getElementsByID("login_error").innerHTML = "";
          } else if (m_ID == "signUpBox") {
            document.getElementsByID("signup_error").style = "display: none";
            document.getElementsByID("signup_error").innerHTML = "";
          } else if (m_ID == "ResetPassword") {
            document.getElementsByID("fpass_error").style = "display: none";
            document.getElementsByID("fpass_error").style = "display: none";
  ...
  document
    ...
    .on("scroll", function (e) {
      ...
      if (isScroll) {
        document
          .querySelector(".ListingTable th:nth-child(2), td:nth-child(2)")
  ...
  document.querySelector(".historical-data").on("scroll", function (e) {
    ...
    if (isScroll) {
      document
        .querySelector(".ListingTable th:nth-child(1), td:nth-child(1)")
        .classList.add("before");
    } else {
      document
        .querySelector(".ListingTable th:nth-child(1), td:nth-child(1)")
  ...
  document.querySelector(".header-for-mobile .searchPopup").click(function () {
    ...
    document.querySelector(".searchDiv-for-mb").clasList.add("active");
  });
  ...
  (function () {
    window.scroll(function () {
      ...
      if (scrolled > 200)
        document.querySelector(".gototopIconDiv").fadeIn("slow");
      if (scrolled < 200)
        document.querySelector(".gototopIconDiv").fadeOut("slow");
    });

    document
      .querySelector(".gototopIconDiv")
      .addEventListener("click", function () {
...
// == == == faq scripts == == == //
document
  .querySelector(".faqAcc .flexAccHead")
  .addEventListener("click", function () {
    let AccHeadObj = this;
...
function toggleCurrencyMoreData(elem) {
  ...
  if (currentstate == alternate) {
    document.querySelector(".currencyDetail .bottomListing").style.display =
      "none";
